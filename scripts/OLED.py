...
with canvas(device) as draw:
    ...
    top = padding
    x = padding
    font_path_small = os.path.abspath(os.path.join(os.path.dirname(__file__), '/opt', 'fonts', 'radiospace.ttf'))
    font_path_big = os.path.abspath(os.path.join(os.path.dirname(__file__), '/opt', 'fonts', 'digital-7.ttf'))
